 ...
 * under the License.
 */
package com.github.shareme.gwsmaterialuikit.library.mrangebar;
...
public class RangeBar extends View {
    ...
    public void setTickStart(float tickStart) {
        ...
        if (isValidTickCount(tickCount)) {
            ...
            Timber.e("tickCount less than 2; invalid tickCount.");
    ...
    public void setThumbIndices(int leftThumbIndex, int rightThumbIndex) {
        if (indexOutOfRange(leftThumbIndex, rightThumbIndex)) {
            ...
            Timber.e("A thumb index is out of bounds. Check that it is between 0 and mTickCount - 1");
    ...
    public void setThumbValues(float leftThumbValue, float rightThumbValue) {
        if (valueOutOfRange(leftThumbValue, rightThumbValue)) {
            Timber.e("A thumb value is out of bounds. Check that it is greater than the minimum and less than the maximum value");
            throw new IllegalArgumentException(
    ...
    private void rangeBarInit(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            if (isValidTickCount(tickCount)) {
                ...
                Timber.e("tickCount less than 2; invalid tickCount. XML input ignored.");
            }
